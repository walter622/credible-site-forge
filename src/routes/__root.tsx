  ...
  head: () => ({
    meta: [
      ...
      { title: "Flar Consulting — Tecnologia, IA e Cibersegurança Corporativa" },
      {
        name: "description",
        content:
          "Consultoria de tecnologia corporativa: ERP SAP e Oracle, Salesforce, hiperautomação com IA, cibersegurança e governança.",
      },
      { name: "author", content: "Flar Consulting" },
      { property: "og:site_name", content: "Flar Consulting" },
